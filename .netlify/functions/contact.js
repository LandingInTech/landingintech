...
exports.handler = async (event, context, callback) => {
  ...
  if (event.httpMethod !== 'POST') {
    await callback(null, { statusCode: 405, body: 'Method Not Allowed', headers: {'Allow': 'POST'}})
  }
  ...
  try {
    ...
    await callback(null, {statusCode: 200, body: "Your message was sent successfully! We'll be in touch soon."})
  } catch(err) {
