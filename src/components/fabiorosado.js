  ...
  return (
    <div className="episode-card">
      ...
      <div className="mx-8 pt-5">
        ...
        <p>
          <a href="https://fabiorosado.dev">Website</a> |{" "}
          <a href="https://twitter.com/FabioRosado_"> Twitter</a> |{" "}
          <a href="https://github.com/FabioRosado"> Github</a> |{" "}
          <a href="https://www.instagram.com/FabioRosado"> Instagram</a>
        </p>
      </div>
    </div>
  )
