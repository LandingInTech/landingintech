...
const Header = () => (
  ...
  <div className="sound-cloud">
    <iframe className="mb-0" width="100%" height="20" scrolling="no" frameBorder="no" allow="autoplay" title="latest episode" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/907735096&color=%23fc4056&inverse=true&auto_play=false&show_user=true"/>
  </div>
