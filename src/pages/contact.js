    ...
    <Layout>
      ...
      <section className="py-12 flex flex-col md:flex-row">
        <div className="md:w-1/2 mr-12">
          ...
          <p>
            You can contact us by getting in touch through social media, filling
            out the form or by sending us an email at{" "}
            <span
              role="button"
              tabIndex={0}
              className="email"
            ...
            >
              hello@landingintech.com{" "}
              {copied ? (
                <span className="copied-tooltip">Copied to the clipboard!</span>
              ) : (
                ""
              )}{" "}
            </span>
        ...
        <div className="flex-grow">
          <form className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              {sent ? (
                <>
                  <i className="gg-check mr-2" /> Sent Successfully
                </>
              ) : (
                <>
                  <i className="gg-mail mr-2" /> Send Message
                </>
              )}{" "}
            </button>
